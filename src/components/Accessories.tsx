...
interface AccessoriesCardsProps {
  onScreen?: boolean;
  label: string;
  price: string;
  src: any;
...
const Accessories: FC<AccessoriesProps> = ({onScreen}) => {
  const navigation = useNavigation<any>();
  return (
    <View style={styles.container}>
      <View style={onScreen ? {display: 'none'} : styles.textContainer}>
        <Text style={styles.textHeadtitle}>Accessories</Text>
        <Text
          testID="trending-nav"
...
const AccessoriesCard: FC<AccessoriesCardsProps> = ({
  label,
  price,
  src,
  onScreen,
